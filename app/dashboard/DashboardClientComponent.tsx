...
interface PlayerDisplayStats {
  ...
  // Removed winStreak as data is not available
}
...
export default function DashboardClientComponent({
  ...
  // Initialize displayStats - Removed winStreak
  ...
  useEffect(() => {
    if (initialError || leaderboardData.length === 0) {
        // Reset stats, removing winStreak
    ...
    try {
        ...
        if (!selectedPlayerId) {
            ...
            if (playerData) {
                // Calculate display values - Removed winStreak
                statsToDisplay = {
                    gamesPlayed: playerData.gamesPlayed,
                    winLossStr: `${playerData.wins}W / ${playerData.draws}D / ${playerData.losses}L`,
                    winRateDisplay: formatWinRate(playerData.winRate),
                };
            } else {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Header and Player Selector (same as before) */}
      ...
      {/* Top Stat Cards - REMOVED Win Streak Card */}
      ...
      {/* --- Widgets Section (same as before) --- */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
        {/* Widget 1: Top 3 Leaderboard Snippet (same as before) */}
        ...
        {/* Widget 2: Best Chemistry Duo (same as before) */}
        <div className="lg:col-span-1 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
           {/* ... content ... */}
        ...
        {/* Widget 3: Last Match (same as before) */}
        <div className="lg:col-span-1 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
            {/* ... content ... */}
